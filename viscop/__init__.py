...
def model_init(model_path=None, max_visual_tokens=None, **kwargs):
    ...
    processor = ViSCoP_Processor(image_processor, tokenizer, include_visual_tokens=model.config.include_visual_tokens, include_visual_probes=model.config.include_visual_probes, num_visual_probes=model.config.num_visual_probes)
