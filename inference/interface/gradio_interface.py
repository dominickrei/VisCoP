...
<div style="display: flex; align-items: center; justify-content: center; width: 100%;">
    <img src="https://webpages.charlotte.edu/dreilly1/viscop_logo.png" alt="VisCoP" style="height: 160px; margin-right: 15px;">
    <div style="text-align: center;">
        <h1 style="font-size: 40px; margin-bottom: 5px; font-weight: bold;">VisCoP</h1>
        <h1 style="font-size: 30px;">
            <span style="text-decoration: underline;">Vis</span>ual 
            <span style="text-decoration: underline;">Co</span>ntextualized 
            <span style="text-decoration: underline;">P</span>robing for Domain Adaptation of Vision Language Models
        </h1>
    </div>
    <img src="https://brand.charlotte.edu/wp-content/uploads/sites/183/2023/04/Master_logo.png" alt="UNC Charlotte" style="height: 100px; margin-right: 5px; margin-left: 20px;">
</div>
"""
